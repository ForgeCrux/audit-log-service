 ...
 * ErrorResponse
 */
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-08-14T07:29:28.385377570Z[GMT]")public class ErrorResponse {
  ...
  */
   ...
   * @return errorCode
  */
    @Schema(name = "errorCode", example = "INVALID_DATE_RANGE", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   * @return message
  */
  @NotNull   @Schema(name = "message", example = "Validation failed: fromDate must be before toDate", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
   ...
   * @return path
  */
    @Schema(name = "path", example = "/v1/events", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("path")
